...
using itfco.Entity.Entities.Permissions.Permissions;
...
namespace itfco.Service.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public PermissionService(Context context, IMemoryCache cache, IUserService userService)
        {
            _context = context;
            _cache = cache;
        ...
        public async Task<bool> CheckPermission(Entity.Enum.PermissionEnum permission, Guid userId)
        {
