...
namespace Toplearn.Web.Migrations
{
    ...
    [Migration("20250409132159_changePriceDouble")]
    partial class changePriceDouble
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Blogs.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.Course", b =>
                {
                    ...
                    b.Property<string>("ShortDescriptionPersian")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.CourseCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Permissions.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PermissionId = 22,
                            PermissionTitle = "CartManagement"
                        },
                        new
                        {
                            PermissionId = 23,
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.Cart", b =>
                {
                    b.HasOne("Toplearn.DataLayer.Entities.Courses.Discount", "Discount")
                        .WithMany()
            ...
            modelBuilder.Entity("Toplearn.DataLayer.Entities.Courses.CourseCart", b =>
                {
                    b.HasOne("Toplearn.DataLayer.Entities.Courses.Cart", "Cart")
